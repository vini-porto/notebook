...
- ==**Apple** expanded its repair program worldwide.==
- ==**Apple** arrived late to rehearsal.==
- ==**Apple** presented her research at the conference.==
- ==Professor **Apple** published a new monograph.==
- ==Detective **Apple** arrived at the scene.==
- ==The single first appeared on **Apple** in 1968.==
- ==Their contract with **Apple** covered international distribution.==
- ==**Apple** developer accounts require two-factor authentication.==
- ==Our **Apple** subscription renews every September.==
...
- ==Farmers cultivate the **banana** for its fruit.==
- ==She wore a dress in a soft **banana** shade.==
- ==The artist chose **banana** for the sun in the painting.==
- ==The player executed a stunning **banana** to win the match.==
- ==Fans cheered as the **banana** curved into the net.==
- ==The artist painted a **banana** curve on the wall.==
- ==The road had a **banana** bend around the hill.==
- ==She acted **banana** after winning the lottery.==
- ==His **banana** antics at the party were unforgettable.==

# Orange

>[!EXAMPLE] Expressions with **Orange**
>- **orange pill:** convert someone to a cryptocurrency enthusiast

- ==She wore an **orange** dress to the party.==
- ==The artist chose **orange** for the background.==
- ==Her dress was a bright **orange**.==
- ==He packed an **orange** in his lunchbox.==
- ==The **orange** was juicy and delicious.==
- ==He drank an **orange** to refresh himself.==
- ==An **orange** was served with breakfast.==
- ==The **orange** was planted last spring.==
- ==They pruned the **orange** to encourage growth.==

# Grape

- ==The **grape** harvest was abundant this year.==
- ==The **grape** thrived in the warm climate.==
- ==Grapes are pruned in early spring.==
- ==The walls were painted in a rich **grape** hue.==
- ==She chose **grape** for the color of her new car.==
...
- ==Farmers are cultivating a new variety of **strawberry**.==
- ==Her dress was a lovely **strawberry** hue.==
- ==The sunset cast a **strawberry** glow over the horizon.==
- ==She noticed a **strawberry** on his cheek.==
- ==Doctors examined the **strawberry** on the infant's back.==
# Blueberry

- ==The **blueberry** pie was delicious.==
- ==I planted a **blueberry** in the backyard.==
- ==The **blueberry** requires acidic soil to thrive.==

# Raspberry
*(food) small, soft red fruit from bramble bushes / (mouth noise) sound made by blowing air through closed lips*

>[!EXAMPLE] Expressions with **Raspberry**
>- **blow a raspberry:** make a rude noise with the tongue and lips
>- **get a raspberry:** receive a sound of mockery or disapproval
>- **give the raspberry:** make a rude noise with the mouth

- ==Raspberries are her favorite fruit for breakfast.==
- ==The baby blew a **raspberry** and giggled.==
- ==She responded with a **raspberry** to his silly joke.==
...
- ==The jam was made from wild **blackberry**.==
- ==She picked a ripe **blackberry** from the bush.==
- ==The **blackberry**'s thorns made harvesting difficult.==

# Cherry
*(fruit) small round fruit that is typically red or black / (nature) reddish hardwood from fruit trees commonly used for furniture*

---
Can be used as an **adjective** for color, flavor but also, quality: in excellent condition
- His car is in cherry condition.
- The vintage guitar is in cherry shape.
- Her dress was in cherry condition for the gala.
---
...
- ==Her lips were a natural **cherry** shade.==
- ==We planted a **cherry** in the backyard last spring.==
- ==Birds love to nest in the **cherry** by the river.==
- ==The cabinet was crafted from **cherry**.==
- ==He admired the rich hue of the **cherry**.==
- ==The **cherry** car stood out in the parking lot.==
- ==Her **cherry** lipstick matched her shoes.==
- ==The vintage guitar is in **cherry** shape.==
- ==Her dress was in **cherry** condition for the gala.==
- ==The soda had a refreshing **cherry** taste.==
